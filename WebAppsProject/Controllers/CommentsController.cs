...
namespace WebAppsProject.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public CommentsController(ApplicationDbContext context, UserManager<ApplicationUser> manager)
        {
            _context = context;
            _manager = manager;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Post,Date,AId")] Comment comment)
        {
            Announcement announcement = await _context.Announcement
                .SingleOrDefaultAsync(m => m.Id == comment.AId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Post,Date")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
